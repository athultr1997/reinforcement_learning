        ...
        for Bα in range(B.poissonα.α, B.poissonα.β):
            for Aβ in range(A.poissonβ.α, A.poissonβ.β):
                for Bβ in range(B.poissonβ.α, B.poissonβ.β):
                    ...
                    print('rent_actual1=', valid_requests_A)
                    print('rent_actual2=', valid_requests_B)
                    ...
                    # print("rewards=",rew,"; prob=",ζ,"; exp_val=",ψ,"new_state = (",new_s[0],",",new_s[1],")")
...
# print(expected_reward((10,10),-1))

print(expected_reward((1,1),-1))
# p = poisson_(4)
# print(p.vals)
# print(p.α)
# print(p.β)